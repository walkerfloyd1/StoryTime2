...
import { deleteComment } from '../../../actions/story';

const AddToStoryItem = ({
    postId,
    comment: { _id, 
            text,
            name,
...
export default connect(mapStateToProps, { deleteComment })(AddToStoryItem);
